      ...
      <div className="footer__wrapper">
        ...
        <div className="contacts">
          ...
          <ul className="contacts__list">
            <li className="contacts__item">г. Санкт-Петербург, м. Невский проспект, ул. Казанская 6. 8-812-500-50-50 </li>
            <li className="contacts__item">Режим работы: с 11:00 до 20:00, без выходных.</li>
          </ul>
        </div>
